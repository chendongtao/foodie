...
public class UsersController {
    ...
    public IMOOCJSONResult createUsers(@RequestBody UserBo userBo, HttpServletRequest request, HttpServletResponse response){
        ...
        return IMOOCJSONResult.ok(setNullProperties(user));
    }
